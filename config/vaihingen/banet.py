...
from geoseg.models.BANet import ManifoldMixupModel
from geoseg.models.BANet import PatchUpModel
...
weights_name = "banet-r18-512-crop-ms-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "banet-r18-512-crop-ms-e100"
...
# net = ManifoldMixupModel(net,num_classes=6, alpha=1)
# net = PatchUpModel(net,num_classes=num_classes, block_size=7, gamma=.9, patchup_type='soft')

# define the loss
loss = SoftCrossEntropyLoss(ignore_index=ignore_index)
use_aux_loss = False
