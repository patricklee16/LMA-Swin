...
from geoseg.models.MAResUNet import maresunet_small
...
weights_name = "maresunet-small-1024-ms-512crop-e70"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "maresunet-small-1024-ms-512crop-e70"
...
#  define the network
net = maresunet_small(num_classes=num_classes)
